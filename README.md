...
**All 30 chapters live** under `/learn/` — the manual is complete.
Five appendices (glossary, supplier directory, design resources,
troubleshooting, community builds) remain planned. Handles are frozen per the Content &
