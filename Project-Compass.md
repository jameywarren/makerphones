...
30 chapters in six parts — Fundamentals → Components & Materials → Design & Build → Measurement & Tuning → Advanced → Special Topics — plus five appendices. **State: 13 of 30 written** — Parts 1–2 complete (Ch 1–12) and Ch 13 (Design Methodology). Remaining: Ch 14–17, Parts 4–6, appendices.
