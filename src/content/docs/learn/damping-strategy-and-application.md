---
title: Damping Strategy and Application
handle: damping-strategy-and-application
part: 3
chapter: 17
difficulty: Intermediate
prerequisites: [damping-materials, acoustic-chamber-design]
related: [damping-materials, acoustic-chamber-design, tuning-with-damping, driver-mounting-and-assembly, understanding-frequency-response]
read_time: 10
tags: [damping, tuning, build, acoustics]
description: "Where and how to apply damping in your build to fix specific problems: a strategy for using felt, foam, and fill instead of just stuffing the cup."
excerpt: Damping isn't "add foam until it sounds better." Each placement fixes a specific problem. Here's how to think about where it goes and why.
---

Damping is the finest tuning lever you have, and the easiest one to overdo. [Damping materials](/learn/damping-materials) covered what to use: felt, open-cell foam, fiber fill, and what each does to sound. This chapter is about where to put it and why, which is a different and more useful skill than knowing the materials. A builder who understands placement can tune a headphone with a single sheet of felt; a builder who doesn't will stuff a cup full of foam and wonder why it went dead.
...
- **Chasing a treble peak into a dull top end.** A thin ring is plenty up front. Too much felt and you've traded a peak for a lifeless treble, a worse trade than you think.
:::

## What's Next

You can do all of this by ear, and many great builds are tuned exactly that way. But the moment you want to see what each change actually does, and stop guessing, you bring in measurement. [Tuning with damping](/learn/tuning-with-damping) is the measurement-driven version of everything here: measure, change one thing, measure again, and watch the problem shrink.
