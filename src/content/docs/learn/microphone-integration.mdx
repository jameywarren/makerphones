...
Most headset problems actually live here, so it's worth getting right.
...
A small connector on the cup that makes the boom mic detachable is the most flexible arrangement, headset when you want it, clean headphones when you don't. Remember that an electret needs the host to supply plug-in power; most jacks and interfaces do, but a few don't, and a mic that's dead on one device but fine on another may just be missing its bias. Sidetone, hearing your own voice in the headphones, is usually handled by the host or its software rather than by the headphone itself, but it's worth knowing the term when someone asks why they can't hear themselves. And always test on the actual target device, because pinout and power vary between a phone, a PC, and an audio interface.

## Getting clean voice

A few habits do more for how you sound than any capsule upgrade. Position a boom mic just off to the side of your mouth rather than dead in front of it, directly in the breath stream is where plosive pops and breath noise come from. A cheap foam windscreen over the element kills most of those pops and breath sounds for a dollar. Set the gain on the host so your normal speaking voice sits well below clipping but comfortably above the noise floor; too hot and you clip and distort, too low and you bury the voice in hiss. And remember that a directional element placed close to your mouth beats any amount of software noise suppression. The reliable way to judge any of this is to record yourself and listen back, rather than trusting "can you hear me okay?"

:::tip
Make the boom mic detachable with a small connector on the cup. You get a proper near-mouth mic for calls and gaming when you want it, and clean, mic-free headphones when you don't, and it's easy to wire. A flip-to-mute or detachable boom also keeps the mic out of your face when you're just listening.
:::
