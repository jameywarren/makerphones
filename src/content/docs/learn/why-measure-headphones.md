---
title: Why Measure Headphones
handle: why-measure-headphones
part: 4
chapter: 18
...
**Comparing to a target.** You can overlay your curve against a target, a research-based preference curve, a commercial headphone you like, or your own reference, and see precisely where and by how much you deviate. [Understanding frequency response](/learn/understanding-frequency-response) covers what those curves mean and why flat is not the goal.
...
:::tip
Measure before *and* after every change, and save each file with a name that says what you did. The overlay of "before versus after" is the most useful single thing measurement gives a builder. It shows you exactly what your tweak changed, with no guesswork and no reliance on memory, which is the part of tuning your ears are worst at.
:::

## Common Mistakes

:::caution
- **Trusting absolute numbers from a hobby rig.** Read changes and shapes, not exact dB values as though they came from a reference head.
- **Tuning to flat.** Chasing a ruler-straight graph fights the way you actually hear. Aim at a target curve instead.
- **Not saving measurements.** Without a record you can't compare, can't back out a bad change, and will repeat your own mistakes.
- **Believing a single measurement.** Positioning varies seating to seating. Re-seat and remeasure before you act on a small feature. It may not be there the second time.
- **Skipping the known-headphone check.** Measure something familiar first so you know how to read your own rig before you trust it on a build.
:::

## What's Next

Knowing why to measure is one thing; getting a rig you can trust without spending thousands is the next, and a budget measurement setup, what to buy and how to assemble it, is where this section goes from here. Once you can measure, [tuning with damping](/learn/tuning-with-damping) puts the rig to work on an actual build.
