---
title: Listening Safely
handle: listening-safely
prerequisites: []
related: [why-measure-headphones, taking-and-interpreting-measurements, budget-measurement-setup]
read_time: 3
tags: [safety, hearing, listening, measurement]
description: "A short, practical note on protecting your hearing while building headphones: the real risks of running loud test tones near your ears, and the simple habits that handle them."
excerpt: "Your ears are the one instrument in this hobby you can't replace. A few habits, built in from the start, keep them that way."
---

Building headphones means putting transducers an inch from your eardrums and then, during measurement and tuning, running loud test tones through them over and over. That's a combination worth respecting. Your ears are the one instrument in this whole hobby you can't replace, recalibrate, or print a new copy of, so a few simple habits are worth building in from the start.
...
The fixes are easy, and worth making automatic.

**Turn the volume all the way down before you plug anything in or start a new sweep**, then bring it up gradually. This one habit heads off most of the sudden-blast scenarios on its own.

**Don't wear an untested build while you first power it up** or run a new test signal. Hold it off your ears, or start it whisper-quiet, and confirm nothing's wrong before it's sealed against your head.
