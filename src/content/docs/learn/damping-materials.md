...
**Mistake 1: Filling the entire chamber with foam.** Problem: Kills dynamics, sounds dead. Solution: Strategic placement, not complete fill.
...
Now that you understand damping materials and how to use them, you're ready to learn about the final component category: cables, connectors, and hardware. In [Cables, Connectors & Hardware](/learn/cables-connectors-hardware/), we'll cover wiring, connection options, and all the small parts that hold your headphones together.
