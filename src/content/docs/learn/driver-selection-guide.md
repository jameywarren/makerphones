---
title: "Driver Selection Guide"
handle: driver-selection-guide
part: 2
chapter: 7
difficulty: Beginner
prerequisites: [driver-technologies, impedance-and-sensitivity]
...
**Where will you use these headphones?** Home only, or portable use? This determines [impedance](/learn/impedance-and-sensitivity/) requirements. Home use with a dedicated amp? You can go up to 300Ω. Portable use with phones/laptops? Stick to 32Ω.
...
**Open-back or closed-back?** As we discussed in [Open vs Closed Back Design](/learn/open-vs-closed-back-design/), this affects everything.

## The Key Specs to Evaluate

### Driver Diameter: 40mm vs. 50mm

As we covered in [Headphone Form Factors](/learn/headphone-form-factors/), 40mm is the right choice for most first builds. Larger selection, smaller cups possible, easier to work with. The bass difference is real but smaller than marketing claims.

### Impedance: Match to Your Source
...
## Recommended Drivers for First Builds
...
## AliExpress: Proceed with Caution
