...
handle: supplier-directory
type: appendix
description: "Where to source what: drivers, the Fostex modding platform, ear pads, damping, cable and connectors, filament, measurement gear, and electronics, organized by category, with durable sources and the strategies that outlast any single shop."
excerpt: "Where to buy the things a build needs, by category. Suppliers and prices change faster than anything else here, so this leans on durable sources and sourcing strategies over a brittle shop list."
related: [driver-selection-guide, sourcing-components, damping-materials, cables-connectors-hardware, budget-measurement-setup, bluetooth-integration]
...
You rarely need a branded kit. Acoustic foam, felt, fiber fill or natural wool, and even modeling clay for baffles are inexpensive from general craft, hardware, and online sources, and many builders buy what amounts to a lifetime's supply for the price of a single branded mod kit. The branded kits save you the cutting and the guesswork, which has value for a first project, but the materials themselves are commodity items. [Damping materials](/learn/damping-materials) covers what each one does.

## Cable and connectors

DIY-audio retailers and the marketplace carry headphone cable and the connectors you'll need: 3.5 mm and 2.5 mm plugs, mini-XLR for balanced connections, and MMCX or two-pin for in-ear monitors. [Cables, connectors, and hardware](/learn/cables-connectors-hardware) covers the choices and the wiring.

## Filament and 3D printing

Standard PLA and PETG from any filament supplier will cover most builds: PLA for ease, PETG where you want a little more toughness and damping. If you don't own a printer, online print services and local makerspaces will print your parts from a model, which is a low-commitment way to start before investing in a machine of your own.

## Measurement gear

This is covered in detail in [budget measurement setup](/learn/budget-measurement-setup), so in brief: miniDSP sells the UMIK measurement microphones and the EARS and EARS Pro headphone fixtures directly; calibrated-microphone specialists offer individually corrected UMIKs; and the broad marketplace is where IEC 711 clone couplers live, alongside the printable measurement stands shared by the community.

## Electronics for wireless and active builds

For Bluetooth and other powered builds, specialist audio-electronics retailers and the marketplace carry the pieces: Bluetooth receiver boards built around the common Qualcomm chips, fully integrated Bluetooth modules, lithium-polymer cells, and charging and protection boards. [Bluetooth integration](/learn/bluetooth-integration) covers what to look for, especially matching a board's codec support to the devices you actually use.
