...
import AirSpring from '../../../components/diagrams/AirSpring.astro';
...
As we discussed in [How Headphones Create Sound](/learn/how-headphones-create-sound/), you're building a complete acoustic system, not a driver housing. The chamber affects:
...
**The front chamber** is the space between the driver face and your ear, essentially the volume created by the ear cup and ear pad when they're on your head. The sound you hear is created here. Its volume (determined largely by the ear pad depth) affects the relative bass level and the sound's "openness."
...
<Figure label="Fig. 1" caption="The rear-chamber air spring: smaller volume, stiffer spring.">
  <AirSpring />
</Figure>


The sweet spot for most closed-back over-ear headphone rear chambers is 80–150cc (cubic centimeters). Commercial headphones cluster here because it provides decent bass extension while keeping the cups manageable.
...
Push the driver farther from your ear and a few things happen together:
...
Pull it closer and you get the reverse:
...
The chamber ends where it meets your head, at the interface that does as much for the sound as anything inside the cup: ear pads. In [Ear Pads and Comfort](/learn/ear-pads-and-comfort/), we'll cover how pad choice affects both sound and comfort, and how to select the right pads for your build.
