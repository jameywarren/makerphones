...
// Canonical token mapping (Astro-ready): hardcoded hex stays as fallback so
// the same markup renders identically inside the site (--mp-* themes, dark
// mode included) and standalone. Washes via color-mix() on the tokens.
// NOTE for implementation: two tokens beyond the documented six are assumed —
// --mp-ground (#f9fafb) and --mp-hair (#d1d5db / #e5e7eb).
const MP = {
  ink: 'var(--mp-charcoal, #2d3748)',     // structure
  accent: 'var(--mp-accent, #ea580c)',    // active / moving — used sparingly
  dark: 'var(--mp-ink, #111827)',         // dark mass (magnets, walls)
  label: 'var(--mp-meta, #6b7280)',       // label text
  faint: 'var(--mp-faint, #9ca3af)',      // leader lines
  hair: 'var(--mp-hair, #d1d5db)',        // hairlines, air
  ground: 'var(--mp-ground, #f9fafb)',    // off-white ground
  washInk: 'color-mix(in srgb, var(--mp-charcoal, #2d3748) 8%, transparent)',
  washInkSoft: 'color-mix(in srgb, var(--mp-charcoal, #2d3748) 5%, transparent)',
  washAccent: 'color-mix(in srgb, var(--mp-accent, #ea580c) 7%, transparent)',
  tint: 'color-mix(in srgb, var(--mp-charcoal, #2d3748) 9%, var(--mp-ground, #f9fafb))',
